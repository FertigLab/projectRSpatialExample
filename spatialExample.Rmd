...
nPat <- 20
runParams <- new("CogapsParams", nPatterns = nPat, singleCell = TRUE, seed = 123, nIterations = 50000)
...
projPosCgps <- projectR(t(insitu.matrix),loadings = dataCogaps100, full = T)
```
